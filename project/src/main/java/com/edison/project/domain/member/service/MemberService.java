...
public interface MemberService {
    ...
    ResponseEntity<ApiResponse> logout(CustomUserPrincipal userPrincipal, String accessToken);
    ResponseEntity<ApiResponse> refreshAccessToken(CustomUserPrincipal userPrincipal);
