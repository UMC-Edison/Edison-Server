...
public interface MemberService {
    ResponseEntity<Response> updateProfile(CustomUserPrincipal userPrincipal, MemberRequestDto.UpdateProfileDto request);
    ResponseEntity<Response> getProfile(CustomUserPrincipal userPrincipal);
    ...
    ResponseEntity<Response> logout(CustomUserPrincipal userPrincipal);
    ResponseEntity<Response> refreshAccessToken(String token);
    ResponseEntity<Response> cancel(CustomUserPrincipal userPrincipal);
